                ...
                <div className="text-center mb-6">
                  <div className="relative mb-4">
                    <img
                      src={employee.image}
                      alt={employee.name}
                      className={`w-24 h-24 rounded-full mx-auto object-cover object-[center_15%] ${employee.name === "Shaun Meyers" ? "scale-[2.06]" : "scale-125"} border-4 border-background shadow-lg group-hover:shadow-xl transition-shadow`}
                    />
