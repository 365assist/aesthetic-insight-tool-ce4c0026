...
const Shop = () => {
  ...
  const { addToCart, buyNow, isInitialized } = useShopifyBuy();
  ...
  const convertVariantId = (variantId: string): string => {
    // Convert gid://shopify/ProductVariant/123456 to base64 encoded format
  ...
  const sortedProducts = [...filteredProducts].sort((a, b) => {
    ...
    // Cool Breeze goes third
    if (a.title.includes('Cool Breeze')) return -1;
    if (b.title.includes('Cool Breeze')) return 1;
